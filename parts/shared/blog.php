    ...
    <div class="container p-5 ">
        <div class="row">
            ...
            <div class="col-lg-6 text-start ">
                ...
                <a href="<?php echo get_permalink(get_option('page_for_posts')); ?>" class="btn btn-primary mt-5">Alle Blog-Artikel anzeigen →</a>
            </div>
        </div>
    </div>
    <div class="container">
            ...
            ?>
                <div class="col-md-4">
                    <div class="card mb-4">
                        ...
                        <?php endif; ?>
                        <div class="card-body">
                            <p class="text-muted text-uppercase pt-2">
                                <?php
                            ...
                            <a href="<?php the_permalink(); ?>" class="btn btn-primary mt-4">Mehr erfahren →</a>
                        </div>
                    </div>
                </div>
            <?php
